  ...
  window: [
    {
      ...
      name: "Frame",
      icon: "🔲",
      fabricDefaults: { width: 300, height: 400, fill: "#a3a3a3", stroke: "#525252", strokeWidth: 3 },
    },
    {
      id: "glass-panel",
      name: "Glass Panel",
  ...
  door: [
    {
      ...
      name: "Frame",
      icon: "🔲",
      fabricDefaults: { width: 300, height: 500, fill: "#a3a3a3", stroke: "#525252", strokeWidth: 3 },
    },
    {
      id: "door-panel",
      name: "Door Panel",
      icon: "🚪",
      fabricDefaults: { width: 260, height: 460, fill: "#d4d4d8", stroke: "#a1a1aa", strokeWidth: 2 },
    },
    {
      id: "glass-panel",
      name: "Glass Panel",
    ...
    },
    {
      ...
      name: "Handle",
      icon: "🔘",
      fabricDefaults: { width: 14, height: 80, fill: "#71717a", stroke: "#3f3f46", strokeWidth: 1, rx: 7, ry: 7 },
    },
    {
      id: "hinge",
      name: "Hinge",
      icon: "🔩",
      fabricDefaults: { width: 16, height: 40, fill: "#71717a", stroke: "#3f3f46", strokeWidth: 1 },
    },
    {
      id: "horizontal-bar",
      name: "Horizontal Bar",
  ...
  cupboard: [
    {
      ...
      name: "Frame",
      icon: "🔲",
      fabricDefaults: { width: 400, height: 500, fill: "#a3a3a3", stroke: "#525252", strokeWidth: 3 },
    },
    {
      id: "shelf",
      name: "Shelf",
  ...
  partition: [
    {
      ...
      name: "Frame",
      icon: "🔲",
      fabricDefaults: { width: 500, height: 400, fill: "#a3a3a3", stroke: "#525252", strokeWidth: 3 },
    },
    {
      id: "glass-panel",
      name: "Glass Panel",
