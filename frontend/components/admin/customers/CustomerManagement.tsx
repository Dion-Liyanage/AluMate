    ...
    <div className="space-y-6">
      ...
      >
        <Card className="bg-gradient-to-br from-zinc-900 via-zinc-950 to-zinc-900 border-zinc-800 shadow-xl overflow-hidden relative group">
          <div className="absolute inset-0 bg-gradient-to-r from-violet-500/10 via-purple-500/8 to-indigo-500/10 pointer-events-none" />
          ...
          <div className="absolute bottom-6 right-24 h-56 w-56 bg-purple-300/12 rounded-full blur-[75px] opacity-35" />
